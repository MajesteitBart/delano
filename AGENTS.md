...
- Keep agent entrypoints such as `PI.md`, `CODEX.md`, and `OPENCODE.md` thin and pointing here. `CLAUDE.md` is the only exception, as Claude still expects a top-level agent entrypoint.
