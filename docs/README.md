...
4. [`viewer-guide.md`](viewer-guide.md) - read-only UI setup and usage.
...
- [`viewer-guide.md`](viewer-guide.md): launch, target selection, port behavior, read-only boundaries, and workflow use.
