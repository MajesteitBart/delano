...
- [x] Docs distinguish view-only, annotate, chat, and apply modes.
- [x] Docs show how agents should consume annotation attachments and run delano context read profiles.
- [x] Docs include validation and rollback commands for the feature.
...
- 2026-06-30T14:56:39Z: Updated viewer README, user/docs/CLI guides, root README, and CLI help to describe review mode, annotation storage, chat attachments, Codex opt-in, and guarded apply safety boundaries.

- 2026-06-30T14:56:30Z: Implementation and sharing decision are complete; docs and CLI help have been updated.
