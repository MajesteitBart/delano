...
slug: 006-delano-operational-sync
owner: bart
status: complete
created: 2026-04-28T23:14:00Z
updated: 2026-05-11T12:44:37Z
outcome: Delano can compare local delivery truth with GitHub and Linear, produce typed drift reports, and guide safe dry-run or apply repairs.
uncertainty: high
probe_required: true
probe_status: completed
---

# Spec: Delano Operational Sync

## Executive Summary
- Turn the handbook sync promise into an executable adapter layer.
- Start with dry-run drift detection before adding remote writes.
- Keep local contracts as source of truth while exposing precise repair options for local and remote drift.
