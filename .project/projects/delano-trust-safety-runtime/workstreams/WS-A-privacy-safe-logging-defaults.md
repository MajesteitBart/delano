---
name: WS-A Privacy-Safe Logging Defaults
owner: bart
status: planned
...
# Workstream: WS-A Privacy-Safe Logging Defaults

## Objective
Make prompt and hook logging opt-in, redacted, and safe to commit around.
