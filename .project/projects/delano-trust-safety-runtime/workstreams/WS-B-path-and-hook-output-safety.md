---
name: WS-B Path and Hook Output Safety
owner: bart
status: planned
...
# Workstream: WS-B Path and Hook Output Safety

## Objective
Prevent accidental absolute path leakage from hooks, scripts, and copied outputs.
