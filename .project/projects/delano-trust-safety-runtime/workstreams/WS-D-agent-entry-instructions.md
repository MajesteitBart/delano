---
name: WS-D Agent Entry Instructions
owner: bart
status: planned
...
# Workstream: WS-D Agent Entry Instructions

## Objective
Upgrade root and adapter-facing instructions into a compact command and boundary index.
