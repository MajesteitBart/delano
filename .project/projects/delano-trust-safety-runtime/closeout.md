...
- `node scripts/propose-closeout-learning.mjs --project delano-trust-safety-runtime` produced one dry-run, proposal-only recommendation and made no mutations.
