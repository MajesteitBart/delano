...
- Created from /goal directive 2026-07-09; owner bart. Operating mode `feature` with a mandatory pre-build probe (H-1). Write boundaries unchanged from 015-delano-viewer-annotations-agent-chat project.
