---
name: WS-A Lease Contracts and Locking
owner: bart
status: planned
...
# Workstream: WS-A Lease Contracts and Locking

## Objective
Represent path ownership, task ownership, expiry, and exclusive conflict areas.
