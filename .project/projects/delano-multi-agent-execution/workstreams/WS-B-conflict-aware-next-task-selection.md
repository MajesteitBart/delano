---
name: WS-B Conflict-Aware Next Task Selection
owner: bart
status: planned
...
# Workstream: WS-B Conflict-Aware Next Task Selection

## Objective
Make ready-task selection account for active leases, dependencies, priorities, and stream capacity.
