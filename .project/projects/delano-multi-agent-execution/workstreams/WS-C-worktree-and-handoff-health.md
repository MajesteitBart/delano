---
name: WS-C Worktree and Handoff Health
owner: bart
status: planned
...
# Workstream: WS-C Worktree and Handoff Health

## Objective
Add worktree checks and required handoff summaries for agent-to-agent continuity.
