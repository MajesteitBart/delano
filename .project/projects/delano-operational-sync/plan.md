...
# Delivery Plan: Delano Operational Sync
...
## Workstream Design
- `WS-A Sync Data Contracts`: Define mapping, drift report, sync plan, and repair action contracts.
- `WS-B GitHub Adapter`: Inspect GitHub issues, PRs, statuses, and release references relevant to local tasks.
- `WS-C Linear Adapter`: Inspect Linear issue status, ownership, dependencies, and project mappings.
- `WS-D Drift CLI and Repair Flow`: Provide dry-run, apply, repair-local, and repair-remote flows with confidence levels.
