---
name: WS-D Drift CLI and Repair Flow
owner: bart
status: done
...
# Workstream: WS-D Drift CLI and Repair Flow

## Objective
Provide dry-run, apply, repair-local, and repair-remote flows with confidence levels.
