...
- `node scripts/propose-closeout-learning.mjs --project delano-contract-enforcement` produced one dry-run, proposal-only recommendation and made no mutations.
