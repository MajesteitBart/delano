...
# Workstream: WS-A Artifact Schemas

## Objective
Define schema contracts for specs, plans, workstreams, tasks, decisions, updates, evidence, and context.
