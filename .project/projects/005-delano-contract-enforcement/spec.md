...
slug: 005-delano-contract-enforcement
owner: bart
status: complete
created: 2026-04-28T23:14:00Z
updated: 2026-05-11T12:44:37Z
outcome: Delano delivery artifacts are validated as executable contracts with schemas, operating modes, state transitions, and evidence-before-done gates.
uncertainty: medium
probe_required: true
probe_status: completed
---

# Spec: Delano Contract Enforcement

## Executive Summary
- Move Delano from handbook-led process toward mechanically checked delivery contracts.
- Add schemas for the major project artifact types and wire them into strict validation.
- Introduce operating modes so tiny patches and multi-stream features get the right amount of process.
- Make evidence mapping first-class before any task or project can honestly close.
