...
slug: 007-delano-multi-agent-execution
owner: bart
status: complete
created: 2026-04-28T23:14:00Z
updated: 2026-05-11T12:44:37Z
outcome: Delano supports parallel coding agents with explicit file leases, conflict-zone checks, stream-aware task selection, and required handoff summaries.
uncertainty: medium
probe_required: true
probe_status: completed
---

# Spec: Delano Multi-Agent Execution

## Executive Summary
- Make multi-agent execution enforceable instead of relying only on rules and goodwill.
- Add lease contracts so active ownership and exclusive files are visible before work starts.
- Teach task selection and validation about capacity, conflict zones, worktrees, and handoffs.
