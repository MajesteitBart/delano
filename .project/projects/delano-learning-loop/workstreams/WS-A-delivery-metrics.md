...
# Workstream: WS-A Delivery Metrics

## Objective
Track task throughput, reopened work, validation failures, missing evidence, drift incidents, and blocked time.
