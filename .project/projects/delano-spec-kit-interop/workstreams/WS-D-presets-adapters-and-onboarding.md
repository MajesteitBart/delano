---
name: WS-D Presets, Adapters, and Onboarding
owner: delano-team
status: done
...
# Workstream: WS-D Presets, Adapters, and Onboarding

## Objective

Make Delano easier to adopt through presets, adapter metadata, and first-15-minutes documentation.
