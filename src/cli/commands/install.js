...
function getInstallHelp() {
  return [
    ...
    "",
    "Categories:",
    "  agent-runtime, codex-hooks, skills, project-context, project-templates,",
    ...
    "  - Runs the Viewer from the active Delano package; repository-local .delano/viewer copies are not installed or removed.",
